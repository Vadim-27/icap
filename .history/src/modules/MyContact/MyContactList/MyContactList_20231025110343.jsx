...
const ContactList = () => {
  ...
  const contactEdit = id, name, email, birthday_date, phone_number, address => {
    setEditingContactId(id);
    setState(id, name, email, birthday_date, phone_number, address);
  };
      ...
      <li className={css.contactList} key={id}>
        ...
        {id !== editingContactId ? (
          <button
            ...
            type="button"
            onClick={() =>
              contactEdit(id, name, email, birthday_date, phone_number, address)
            }
          >
            {/* Edit */}
            <SvgSelector id="Edit" />
