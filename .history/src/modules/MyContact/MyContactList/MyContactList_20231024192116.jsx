...
const ContactList = () => {
  ...
  const contact = filterList.map(({ id, name, email, birthday_date, phone_number, address }) => (
  ...
  return (
    <>
      <ul className={css.hederTableList}>
        <li className={css.contactItem}>Name</li>
        <li className={css.contactItem}>Number</li>
      </ul>
      <ul>{contact}</ul>;
    </>
  );
